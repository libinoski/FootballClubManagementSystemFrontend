        ...
        const fetchAllNews = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:4040/api/admin/adminViewAllNews',
                    { adminId },
                    {
                        headers: {
                            token
                ...
                if (error.response) {
                    ...
                    switch (status) {
                        ...
                        case 403:
                            ...
                            break;
                        case 422:
                            alert(data.error || 'Admin not found or inactive.');
                            break;
                        case 500:
...
export default AdminViewAllNews;
