    ...
    return (
        <div>
            <div className="container py-5">
                ...
                {/* Placeholder for a Logo if necessary */}
                </div>
...
Join us in shaping the future of football. Embrace efficiency, embrace excellence—welcome to your Football Match Management System.                        </p>
                    </div>
                </div>
