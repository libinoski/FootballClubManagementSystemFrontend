...
import { faUserCircle, faHome, faBell, faFutbol, faPaperPlane, faNewspaper, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light" style={{ borderBottom: '1px solid #e0e0e0', background: 'linear-gradient(120deg, #303030, #212121)' }}>
            <div className="container">
                <Link className="navbar-brand fw-bold d-flex align-items-center" to="/" style={{ color: '#fff' }}>
                ...
                <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerViewProfile" style={{ color: '#fff' }}>
                                <FontAwesomeIcon icon={faUserCircle} className="me-2 text-success" />
                                View Profile
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerViewAllNotifications" style={{ color: '#fff' }}>
                                <FontAwesomeIcon icon={faBell} className="me-2 text-warning" />
                                Notifications
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerViewAllNews" style={{ color: '#fff' }}>
                                <FontAwesomeIcon icon={faNewspaper} className="me-2 text-info" />
                                View News
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerViewAllMatches" style={{ color: '#fff' }}>
                                <FontAwesomeIcon icon={faFutbol} className="me-2 text-danger" />
                                View Matches
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerViewAllClubs" style={{ color: '#fff' }}>
                                <FontAwesomeIcon icon={faHome} className="me-2 text-secondary" />
                                View Clubs
                            </Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/playerSendLeaveRequestToClub" style={{ color: '#fff' }}>
