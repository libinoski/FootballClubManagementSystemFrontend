...
const PlayerViewAllMatchPoints = () => {
        ...
        const fetchAllMatchPoints = async () => {
            ...
            try {
                ...
                const response = await axios.post(
                    'http://localhost:4040/api/player/playerViewAllMatchPoints',
                    { playerId },
                    {
                        headers: {
                            token
...
export default PlayerViewAllMatchPoints;
